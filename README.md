...
<img src="/images/tk_login.jpg" width="40%">
...
## 7. Re-programming(python - Kivy)

- TKinter 사용 시, 버튼이나 개체의 배치에 제약사항이 많아 원하는 UI를 꾸밀수 없었습니다.
- 이에, 새롭게 각광받고 있는 Kivy interface를 이용하여 새롭게 재 코딩하게 되었습니다.
